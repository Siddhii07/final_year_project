...
def model_building(comp_name):
    global df
    global market
    try:
        # df = pdr.get_data_yahoo(comp_name, start=start_date, end=end_date)
        df = stock_df(symbol=comp_name, from_date=date(2020, 11, 11), to_date=date(2023, 11, 11), series="EQ")
        print(df)
        print(df.shape)
        print("Script found in NSE market")
        ...
        print(df)
        print(df.shape)
        print("Script found in US market")
